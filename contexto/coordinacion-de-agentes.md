...
| --- | --- | --- | --- | --- |
| Codex | Fase 0 completada en rama propia | Aislamiento de analítica, línea base productiva, limpieza exclusiva de eventos técnicos y recuperación de controles locales; sin cambios funcionales | `codex/analytics-hardening` y `contexto/analitica-fase-0.md` | Preserva el cambio ajeno de `src/layouts/PublicLayout.tsx`; continuará con Fase 1 sin mezclar el commit de catálogo de Claude |
