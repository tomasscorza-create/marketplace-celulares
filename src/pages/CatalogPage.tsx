        ...
        <div className="grid gap-4 rounded-3xl border border-white/40 bg-white/40 p-3 shadow-elev-2 backdrop-blur-2xl sm:gap-5 sm:p-5">
          ...
          {feedCollections.personalizedShowcaseItems.length > 0 ? (
            ...
            >
              ...
              <div className="pointer-events-none absolute inset-0 z-0 rounded-3xl bg-[url('/catalog_explore_bg.webp')] bg-cover bg-center opacity-35" />
              <div className="pointer-events-none absolute inset-0 z-0 bg-brand-50/80" />
