...
- [ ] Fase 0 — Supuestos verificados (conteos de lotes en 0 confirmados el: ______)
- [ ] Fase 1 — Lotes fuera de UI y orquestación (página, form, modales, lista, stats, submit, validación)
- [ ] Fase 2.1–2.4 — Clients, queries, tipos y borradores limpios
- [ ] Fase 2.5–2.6 — Selects hardcodeados (public/buyer) y admin limpios
- [ ] Fase 2.7 — `grep -ri "batch" src/` en cero
- [ ] Fase 3 — Migración creada
- [ ] Fase 3 — Migración aplicada al backend confirmado
- [ ] Fase 4.1 — Código muerto de borrado de imágenes eliminado
- [ ] Fase 4.2 — Vestigios de refresh manual eliminados
- [ ] Fase 4.3 — `isMissingColumnError` acotado o eliminado
- [ ] Fase 4.4 — Autosave con debounce y carrera resuelta
- [ ] Fase 4.5 — `ArtisanProductsPage` dividido en hooks
- [ ] Fase 4.6 — `ArtisanProductFormSection` dividido
- [ ] Fase 4.7 — Subidas paralelizadas con orden preservado
- [ ] Fase 4.8 — Textos unificados
- [ ] Fase 5 — Verificación final completa y docs actualizadas

### Notas de ejecución

_(El agente anota acá desvíos, deuda nueva detectada fuera de alcance, y decisiones
tomadas, con fecha. Vacío al inicio.)_
